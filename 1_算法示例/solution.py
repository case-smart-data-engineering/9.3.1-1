...
# 精确推理
def precise_reasoning(bayes_model, cpdsList):
    # 将各个节点条件概率分布添加到BN中
    for cpd in cpdsList:
...
if __name__ == '__main__':
    ...
    cpdsList = [smoking_cpd, fever_cpd, breath_cpd, lung_cpd, communicate_cpd]

    # 精确推理
    bayes_infer = precise_reasoning(bayes_model, cpdsList)

    # 查询呼吸困难发生的情况下，病人吸烟的概率
    prob_G = bayes_infer.query(variables=["S"], evidence={"L": 1})
    print(prob_G)
